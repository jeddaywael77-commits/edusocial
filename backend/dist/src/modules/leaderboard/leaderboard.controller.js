...
let LeaderboardController = class LeaderboardController {
    ...
    async getTopByXp(limit) {
        return this.leaderboardService.getTopByXp(limit);
    }
    async getTopByLevel(limit) {
...
__decorate([
    (0, common_1.Get)('xp'),
    (0, swagger_1.ApiOperation)({ summary: 'Get top users by XP' }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false }),
    __param(0, (0, common_1.Query)('limit')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], LeaderboardController.prototype, "getTopByXp", null);
__decorate([
    (0, common_1.Get)('level'),
    (0, swagger_1.ApiOperation)({ summary: 'Get top users by level' }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false }),
    __param(0, (0, common_1.Query)('limit')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], LeaderboardController.prototype, "getTopByLevel", null);
__decorate([
    (0, common_1.Get)('my-rank'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)('access-token'),
    (0, swagger_1.ApiOperation)({ summary: 'Get my rank' }),
